...
g++ -std=c++20 *file_name*.cpp ../src/glad.c -I../include/ -o prog -lSDL2 -ldl
*/
...
void CreateGraphicsPipeline(){
    ...
    const std::string& vs = LoadShaderAsString("../Shaders/vert.glsl");
    const std::string& fs = LoadShaderAsString("../Shaders/frag.glsl");
...
void VertexSpecification(){
    ...
    // Geometry Data
    // Here we are going to store x, y, and z position attributes within vertexPosition for the data
    ...
    // Now, in our currently binded buffer, we populate the data from our 'vertexPosition' (which is in CPU)
    ...
    glBufferData(
        ...
        vertexPosition.data(),                          // Raw array of data (pointer to data)
